...
class Brand(db.Model):
    ...
    def __repr__(self):
        template = "<Brand id=%s name=%s founded=%s headquarters=%s discontinued=%s"
        return template % (self.brand_id,
                           self.name,
                           self.founded,
                           self.headquarters,
                           self.discontinued)
...
class Model(db.Model):
    ...
    def __repr__(self):
        template = "<Model id=%s year=%s brand_id=%s name=%s"
        return template % (self.model_id,
                           self.year,
                           self.brand_id,
                           self.name)
# End Part 1
